...
const Settings = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (videoLink !== '' || chinaAddress !== '' || whatsappNumber !== '' || aboutUsText !== '' || prohibitedItemsText !== '' || contractFile !== '' || tarif !== '') {
                
                const response = await updateSettings(tarif, videoLink, chinaAddress, whatsappNumber, aboutUsText, prohibitedItemsText, contractFile);
        ...
        <div className="status-list">
            ...
            <form className="form-filialAdd" onSubmit={handleSubmit}>
                <div className="inputs-wrapper">
                    <p><b>Тариф в шапке</b></p>
                    <input
                        className="input-filialAdd"
                        type="text"
                        value={tarif}
                        onChange={(e) => setTarif(e.target.value)}
                        placeholder="Тариф в шапке"
                    />
                ...
                <div className="inputs-wrapper">
                    <p><b>Ссылка на уроки</b></p>
                    <input
                        className="input-filialAdd"
                        type="text"
                        value={videoLink}
                        onChange={(e) => setVideoLink(e.target.value)}
                        placeholder="Ссылка на уроки"
                    />
                    <p className="settingsGet">
                ...
                <div className="inputs-wrapper">
                    <p><b>Ссылка на телеграм бот маркетплейсы</b></p>
                    <input
                        className="input-filialAdd"
                        type="text"
                        value={whatsappNumber}
                        onChange={(e) => setWhatsappNumber(e.target.value)}
                        placeholder="Ссылка на телеграм бот маркетплейсы"
                    />
                    <p className="settingsGet">
